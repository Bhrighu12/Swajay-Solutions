...
const AI = () => {
    return (
        <div className="min-h-screen bg-white">
            {/* Hero Section */}
            <section className="w-full bg-gradient-to-r from-[#0B1221] to-[#1a233b] py-24 px-6 md:px-16 text-white min-h-[400px] flex flex-col justify-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            ...
                            <motion.div
                                ...
                                className="bg-white p-8 rounded-xl border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 group flex flex-col"
                            >
                                ...
                                <div className="pt-6 border-t border-gray-100 mt-auto">
                                    ...
                                    <p className="text-sm font-medium text-gray-900">{item.impact}</p>
                                </div>
                            </motion.div>
                        ))}
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {[
                            ...
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                transition={{ delay: index * 0.1 }}
                                className="bg-white p-10 rounded-xl border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300"
                            >
