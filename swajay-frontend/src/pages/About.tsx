...
const About = () => {
    return (
        <div className="min-h-screen bg-white">
            ...
            <section className="py-20 px-6 md:px-16 overflow-hidden">
                <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.6 }}
                        className="bg-blue-50/50 rounded-2xl p-8 md:p-12 border border-blue-100/50 relative overflow-hidden group"
                    >
            ...
            {/* Vision Section */}
            <section className="py-20 px-6 md:px-16 bg-gray-50 overflow-hidden">
                <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
                    <motion.div
                        initial={{ opacity: 0, x: -50 }}
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true }}
                        transition={{ duration: 0.6 }}
                        className="bg-blue-50/50 rounded-2xl p-8 md:p-12 border border-blue-100/50 relative overflow-hidden group order-2 md:order-1"
                    >
                        <div className="relative z-10">
                            <div className="w-16 h-16 bg-white rounded-2xl shadow-sm flex items-center justify-center mb-6 text-primary">
                                <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="absolute bottom-0 left-0 w-32 h-32 bg-accent/5 rounded-full blur-2xl transform -translate-x-10 translate-y-10 transition-transform duration-700 group-hover:scale-150"></div>
                    </motion.div>
            ...
            {/* Stats Section */}
            <section className="bg-[#0B1221] py-20 px-6 md:px-16 text-white">
            ...
            <section className="py-24 px-6 md:px-16 bg-white">
                <div className="max-w-6xl mx-auto">
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="bg-blue-50/30 border border-blue-100 rounded-3xl p-8 md:p-12 mb-16 text-center"
                    >
                        <p className="text-gray-700 leading-relaxed max-w-4xl mx-auto space-y-6 text-lg">
                        ...
                        {[1, 2, 3, 4].map((item) => (
                            ...
                            >
                                <div className="relative h-full w-full transition-all duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                                    {/* Front Face */}
                                    <div className="absolute inset-0 h-full w-full bg-white rounded-2xl [backface-visibility:hidden]">
                                        <div className="h-full w-full flex flex-col">
                                            <div className="flex-1 bg-gray-100 rounded-2xl relative overflow-hidden mb-4">
                                    ...
                                    {/* Back Face */}
                                    <div className="absolute inset-0 h-full w-full bg-[#0B1221] rounded-2xl p-8 text-white [transform:rotateY(180deg)] [backface-visibility:hidden] flex flex-col items-center justify-center text-center shadow-xl">
