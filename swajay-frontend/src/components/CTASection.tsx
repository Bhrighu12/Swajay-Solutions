const CTASection = () => {
    return (
        <section className="bg-gradient-to-b from-[#1E293B] to-[#0F172A] py-24 text-center relative overflow-hidden">
            {/* Background Glow */}
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <button className="flex items-center justify-center px-8 py-3 bg-transparent border border-white/20 text-white font-bold rounded-lg hover:bg-white/10 transition-all duration-300 shadow-lg backdrop-blur-sm">
                        Learn More
                    </button>
                </div>
            </div>
